  ...
  return (
    <header className="pt-20 pb-0 md:pb-10 pl-4 pr-0 md:px-8 max-w-7xl mx-0 md:mx-auto bg-black text-white relative overflow-hidden xl:overflow-visible">
      ...
      */}
            ...
            {/* Name */}
            <p className="mt-4 md:mt-6 font-[family-name:var(--font-brown-sugar)] text-[4.4vw] md:text-[2.5vw] xl:text-2xl tracking-widest text-white uppercase text-left">
              ROKUNDA MBOYI
            </p>

            {/* Added Title */}
            <p className="mt-1 font-[family-name:var(--font-brown-sugar)] text-[2vw] md:text-[1.3vw] xl:text-lg tracking-wider text-white/90 uppercase text-left">
              Aspiring Architect
            </p>
          </div>
          {/* === MAP CONTAINER === */}
